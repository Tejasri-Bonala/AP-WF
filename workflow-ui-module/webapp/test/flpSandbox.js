		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "productApprovalForm",
									"targetURL": "#comaperamworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaperamworkflowuimodule-display": {
								"semanticObject": "comaperamworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aperam.workflowuimodule",
									"url": sap.ui.require.toUrl("com/aperam/workflowuimodule")
								}
							}
						}
					}
